...
public class CreateOwnership {
	...
	public void test() throws InterruptedException {
		...
		body += "<ObjectEvent>\n" + 
				...
				"	<extension>\n" + 
				"		<destinationList>\n" + 
				"			<destination type=\"urn:epcglobal:cbv:sdt:possessing_party\">urn:epc:id:sgln:0000001.00001.0</destination>\n" + 
				"		</destinationList>\n" + 
				"	</extension>\n" + 
				"</ObjectEvent>";
		...
		for (int i = 0; i < count; i++) {
			...
			body += "<ObjectEvent>\n" + 
					...
					"		</sourceList>\n" + 
					"		<destinationList>\n" + 
					"			<destination type=\"urn:epcglobal:cbv:sdt:possessing_party\">urn:epc:id:sgln:0000001.00001." + (i+1) + "</destination>\n" + 
					"		</destinationList>\n" + 
					"	</extension>\n" + 
					"</ObjectEvent>";
		...
		body += "<ObjectEvent>\n" + 
				...
				"	<extension>\n" + 
				"		<sourceList>\n" + 
				"			<source type=\"urn:epcglobal:cbv:sdt:possessing_party\">urn:epc:id:sgln:0000001.00001." + count + "</source>\n" + 
				"		</sourceList>\n" + 
				"	</extension>\n" + 
				"</ObjectEvent>";
