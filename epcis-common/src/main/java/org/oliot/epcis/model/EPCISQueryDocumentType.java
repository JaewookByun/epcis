 ...
 *         &lt;element name="EPCISBody" type="{urn:epcglobal:epcis-query:xsd:2}EPCISQueryBodyType"/>
 *         &lt;element name="extension" type="{urn:epcglobal:epcis-query:xsd:2}EPCISQueryDocumentExtensionType" minOccurs="0"/>
...
@XmlType(name = "EPCISQueryDocumentType", namespace = "urn:epcglobal:epcis-query:xsd:2", propOrder = { "epcisHeader",
