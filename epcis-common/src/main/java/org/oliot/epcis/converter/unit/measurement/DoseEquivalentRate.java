 ...
 *
 * The product of the absorbed dose rate multiplied by a Q factor (relating to
 * the type of radiation) and a factor relating to all relevant aspects of the
 * body being irradiated. SI Units: sievert per second gs1:DoseEquivalentRate
 *
 ...
 */
public class DoseEquivalentRate extends Unit {
	...
	public DoseEquivalentRate(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public DoseEquivalentRate(String uom, Double value) {
