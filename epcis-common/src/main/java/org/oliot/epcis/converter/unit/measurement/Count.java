 ...
 *
 * A measure of the total quantity of something; the number of individual units
 * present. Typically dimensionless (no units) gs1:Count
 *
...
public class Count extends Unit {
	...
	public Count(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public Count(String uom, Double value) {
