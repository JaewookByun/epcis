 ...
 *
 * A measure of the total magnetic field that passes through a specific area.
 * The surface integral of the product of the permeability of the medium and the
 * magnetic field intensity perpendicular to the surface. SI Units: weber
 * gs1:MagneticFlux
 *
