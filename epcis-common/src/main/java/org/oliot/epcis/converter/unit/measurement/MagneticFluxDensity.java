 ...
 *
 * The product of the magnetic field strength and the permeability of a
 * material. SI Units: tesla = weber per square metre gs1:MagneticFluxDensity
 *
...
public class MagneticFluxDensity extends Unit {
	...
	public String toString() {
		return "gs1:MagneticFluxDensity";
	}
}
