...
public class UnitConverter {
	...
	private HashMap<String, List<String>> measurementUnitsMap;
	private HashMap<String, String> measurementRepresentativeUnitMap;

	// public HashMap<String, String> unitToGroup;

	public UnitConverter() {
		measurementUnitsMap = new HashMap<String, List<String>>();

		measurementUnitsMap.put("gs1:AbsoluteHumidity",
				List.of("KMQ", "_23", "D41", "GJ", "B35", "GL", "A93", "GP", "B72", "B34", "H29", "M1", "GQ", "F23",
						"G31", "_87", "GE", "LA", "G32", "K41", "K71", "K84", "L37", "L38", "L39", "L65", "L92",
						"L93"));

		measurementUnitsMap.put("gs1:AbsorbedDose", List.of("A95", "C13", "C80", "A61"));

		measurementUnitsMap.put("gs1:AbsorbedDoseRate",
				List.of("P54", "P55", "P56", "P57", "P58", "P59", "P60", "P61", "P62", "P63", "P64"));

		measurementUnitsMap.put("gs1:Acceleration",
				List.of("MSK", "A76", "C11", "M38", "M39", "M41", "A73", "IV", "K40", "M40", "M42"));

		measurementUnitsMap.put("gs1:Altitude", List.of("MTR", "A11", "A71", "C45", "_4H", "A12", "DMT", "CMT", "MMT",
				"INH", "FOT", "YRD", "NMI", "A45", "HMT", "KMT", "B57", "AK", "M50", "M49", "X1", "M51"));

		measurementUnitsMap.put("gs1:AmountOfSubstance", List.of("C34", "B45", "C18", "FH"));

		measurementUnitsMap.put("gs1:AmountOfSubstancePerUnitVolume", List.of("C36", "M33", "C38", "C35", "B46"));

		measurementUnitsMap.put("gs1:Angle", List.of("C81", "C25", "B97", "A91", "DD", "D61", "D62", "M43", "M44"));

		measurementUnitsMap.put("gs1:Area", List.of("MTK", "KMK", "H30", "DAA", "CMK", "DMK", "H16", "H18", "MMK",
				"ARE", "HAR", "INK", "FTK", "YDK", "MIK", "M48", "ACR", "M47"));

		measurementUnitsMap.put("gs1:Capacitance", List.of("FAR", "H48", "C10", "_4O", "C41", "_4T", "N90"));

		measurementUnitsMap.put("gs1:Conductance", List.of("SIE", "B53", "C27", "B99", "N92", "NQ", "NR"));

		measurementUnitsMap.put("gs1:Count", List.of("C62"));

		measurementUnitsMap.put("gs1:Density",
				List.of("KMQ", "_23", "D41", "GJ", "B35", "GL", "A93", "GP", "B72", "B34", "H29", "M1", "GQ", "F23",
						"G31", "_87", "GE", "LA", "G32", "K41", "K71", "K84", "L37", "L38", "L39", "L65", "L92",
						"L93"));

		measurementUnitsMap.put("gs1:Dimensionless", List.of("C62"));

		measurementUnitsMap.put("gs1:DoseEquivalent", List.of("D13", "C28", "D91", "L31"));

		measurementUnitsMap.put("gs1:DoseEquivalentRate",
				List.of("P65", "P66", "P67", "P68", "P69", "P70", "P71", "P72", "P73", "P74", "P75", "P76", "P77"));

		measurementUnitsMap.put("gs1:DynamicViscosity",
		...
		measurementUnitsMap.put("gs1:ElectricCharge",
				List.of("COU", "A8", "AMH", "TAH", "D77", "D86", "B26", "B86", "C40", "C71", "E09", "N95", "N94"));

		measurementUnitsMap.put("gs1:ElectricCurrent",
				List.of("AMP", "B22", "H38", "_4K", "B84", "C39", "C70", "N96", "N97"));

		measurementUnitsMap.put("gs1:Energy",
		...
		measurementUnitsMap.put("gs1:Force", List.of("NEW", "B47", "B73", "B92", "C20", "DU", "C78", "B37", "B51",
				"L40", "L94", "M75", "M76", "M77", "M78"));

		measurementUnitsMap.put("gs1:Frequency", List.of("HTZ", "KHZ", "MHZ", "A86", "D29"));

		measurementUnitsMap.put("gs1:Illuminance", List.of("B60", "LUX", "KLX", "P25", "P26", "P27"));

		measurementUnitsMap.put("gs1:Inductance", List.of("_81", "C14", "B90", "C43", "C73", "P24"));

		measurementUnitsMap.put("gs1:Length", List.of("MTR", "A11", "A71", "C45", "_4H", "A12", "DMT", "CMT", "MMT",
				"INH", "FOT", "YRD", "NMI", "A45", "HMT", "KMT", "B57", "AK", "M50", "M49", "X1", "M51"));

		measurementUnitsMap.put("gs1:LuminousIntensity", List.of("CDL", "P33", "P34"));

		measurementUnitsMap.put("gs1:MagneticFlux", List.of("WEB", "C33", "P11"));

		measurementUnitsMap.put("gs1:MagneticFluxDensity", List.of("D33", "C29", "D81", "C48", "P13", "P12"));

		measurementUnitsMap.put("gs1:MagneticVectorPotential", List.of("D59", "B56", "D60"));

		measurementUnitsMap.put("gs1:Mass", List.of("KGM", "KTN", "LTN", "_2U", "TNE", "STN", "DTN", "STI", "LBR",
				"HGM", "ONZ", "DJ", "APZ", "GRM", "DG", "CGM", "MGM", "MC", "F13", "CWI", "CWA", "M86"));

		measurementUnitsMap.put("gs1:MassConcentration",
				List.of("KMQ", "_23", "D41", "GJ", "B35", "GL", "A93", "GP", "B72", "B34", "H29", "M1", "GQ", "F23",
						"G31", "_87", "GE", "LA", "G32", "K41", "K71", "K84", "L37", "L38", "L39", "L65", "L92",
						"L93"));

		measurementUnitsMap.put("gs1:MolarEnergy", List.of("B15", "B44"));

		measurementUnitsMap.put("gs1:MolarMass", List.of("D74", "A94"));
		measurementUnitsMap.put("gs1:MolarVolume", List.of("A40", "A37", "A36", "B58"));

		measurementUnitsMap.put("gs1:Power", List.of("WTT", "KWT", "MAW", "A90", "C31", "D80", "F80", "A63", "A74",
				"B39", "HJ", "A25", "BHP", "K15", "K16", "K42", "N12"));

		measurementUnitsMap.put("gs1:Pressure",
				List.of("PAL", "H75", "_74", "A89", "A97", "B96", "KPA", "MPA", "BAR", "MBR", "C55", "C56", "B40", "UA",
						"_80", "H78", "HP", "F79", "F78", "ATT", "ATM", "J89", "K24", "K25", "K31", "E42", "E41", "K85",
						"_84", "N13", "N14", "N15", "N16", "N17", "N18", "N19", "N20", "N21", "N22", "N23", "HN",
						"PS"));

		measurementUnitsMap.put("gs1:Radioactivity",
				List.of("CUR", "MCU", "M5", "_2R", "BQL", "GBQ", "_2Q", "_4N", "H08"));

		measurementUnitsMap.put("gs1:RelativeHumidity", List.of("P1", "_59", "_61", "_60", "E40", "NX", "GK", "NA",
				"J33", "L32", "M29", "K62", "L19", "J36", "H60", "H65", "J87", "L21", "J91"));

		measurementUnitsMap.put("gs1:Resistance", List.of("OHM", "A87", "B75", "H44", "B49", "E45", "B94", "P22"));

		measurementUnitsMap.put("gs1:SpecificVolume", List.of("A39", "_22", "H83", "KX", "N28", "N29", "N30"));

		measurementUnitsMap.put("gs1:Speed", List.of("KMH", "MTS", "HM", "M57", "M58", "KNT", "M62", "H49", "_2M",
				"K14", "FR", "FS", "M63", "IU", "M61", "_2X"));

		measurementUnitsMap.put("gs1:Temperature", List.of("KEL", "FAH", "CEL", "A48"));

		measurementUnitsMap.put("gs1:Time", List.of("SEC", "MIN", "HUR", "DAY", "B52", "C26", "H70", "B98", "C47",
				"WEE", "MON", "ANN", "D42", "L95", "L96", "M56"));

		measurementUnitsMap.put("gs1:Torque", List.of("NU", "B74", "B48", "D83", "B93", "DN", "J72", "B38", "F21",
				"J94", "L41", "M92", "M95", "M96", "M97"));

		measurementUnitsMap.put("gs1:Voltage", List.of("VLT", "N99", "_2Z", "B78", "D82", "KVT"));

		measurementUnitsMap.put("gs1:Volume",
		...
		measurementRepresentativeUnitMap = new HashMap<String, String>();
		for (Entry<String, List<String>> entry : measurementUnitsMap.entrySet()) {
			measurementRepresentativeUnitMap.put(entry.getKey(), entry.getValue().get(0));
		}
...
//		unitToGroup.put("M70", "Volume");
	...
	public String getRepresentativeType(String measurementType) {
		return measurementUnitsMap.get(measurementType).get(0);
	}

	public void checkUnitOfMeasure(String measurementType, String uom) throws ValidationException {
		if (!measurementUnitsMap.get(measurementType).contains(uom)) {
