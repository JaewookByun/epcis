 ...
 * <p>
 * A set of methods related to the conversion from POJO to BSON
 * <p>
 *
...
public class POJOtoBSONUtil {
	...
	public static HashSet<String> bizStep;
	public static HashSet<String> disposition;
	public static HashSet<String> btt;
	public static HashSet<String> sdt;
	public static HashSet<String> er;
	public static HashSet<String> fao3;
	public static HashSet<String> vocabularyType;
	public static HashMap<String, Integer> gcpLength = new HashMap<String, Integer>();
	public static HashSet<String> measurement;
	...
	public static void putDisposition(Document o, String v) throws ValidationException {
		if (v == null)
			return;
		else if (disposition.contains(v))
			o.put("disposition", v);
		else {
			ValidationException e = new ValidationException();
			e.setStackTrace(new StackTraceElement[0]);
	...
	public static void putBizTransactionList(Document o, BusinessTransactionListType v) throws ValidationException {
		...
		try {
			for (BusinessTransactionType bizTranType : v.getBizTransaction()) {
				...
				if (type != null && !btt.contains(type)) {
					ValidationException e = new ValidationException();
					e.setStackTrace(new StackTraceElement[0]);
	...
	public static void putSourceList(Document o, SourceListType v) throws ValidationException {
		...
		try {
			for (SourceDestType sdt : sdtList) {
				...
				if (!POJOtoBSONUtil.sdt.contains(type)) {
					ValidationException e = new ValidationException();
					e.setStackTrace(new StackTraceElement[0]);
	...
	public static void putSensorElementList(Document o, SensorElementListType v) throws ValidationException {
		...
		for (SensorElementType set : v.getSensorElement()) {
			...
			for (SensorReportType e1 : set.getSensorReport()) {
				...
				if (type != null) {
					if (measurement.contains(e1.getType())) {
					...
					String uom = null;
					if (e1.getUom() == null) {
						uom = unitConverter.getRepresentativeType(type);
						sensorReportObj.put("uom", uom);
					} else {
						uom = e1.getUom();
						unitConverter.checkUnitOfMeasure(type, e1.getUom());
						sensorReportObj.put("uom", uom);
					}
					...
					String rUom = unitConverter.getRepresentativeType(type);
					...
					if (e1.getValueAttribute() != null) {
						...
						sensorReportObj.put("rValue", unitConverter.getRepresentativeValue(type, uom, value));
					}
					...
					if (e1.getMinValue() != null) {
						...
						sensorReportObj.put("rMinValue", unitConverter.getRepresentativeValue(type, uom, value));
					}
					...
					if (e1.getMaxValue() != null) {
						...
						sensorReportObj.put("rMaxValue", unitConverter.getRepresentativeValue(type, uom, value));
					}
					...
					if (e1.getMeanValue() != null) {
						...
						sensorReportObj.put("rMeanValue", unitConverter.getRepresentativeValue(type, uom, value));
					}
					...
					if (e1.getPercValue() != null) {
						...
						sensorReportObj.put("rPercValue", unitConverter.getRepresentativeValue(type, uom, value));
					}
