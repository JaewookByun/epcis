...
class JsonVocabularyCaptureReadListener implements ReadListener {
	...
	JsonVocabularyCaptureReadListener(ServletInputStream in, HttpServletResponse r, AsyncContext c) {
		input = in;
		res = r;
		ac = c;
	}
	...
	public void onAllDataRead() throws IOException {
		res.setStatus(200);
		ac.complete();
		JsonVocabularyCapture vc = new JsonVocabularyCapture();
