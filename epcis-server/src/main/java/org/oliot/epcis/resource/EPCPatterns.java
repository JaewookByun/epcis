...
public class EPCPatterns {
	...
	public static final Pattern[] SGTINList = new Pattern[] {
			Pattern.compile("^urn:epc:id:sgtin:([0-9]{12})\\.([0-9]{1})()\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:id:sgtin:([0-9]{11})\\.([0-9]{1})([0-9]{1})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:id:sgtin:([0-9]{10})\\.([0-9]{1})([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:id:sgtin:([0-9]{9})\\.([0-9]{1})([0-9]{3})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:id:sgtin:([0-9]{8})\\.([0-9]{1})([0-9]{4})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:id:sgtin:([0-9]{7})\\.([0-9]{1})([0-9]{5})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:id:sgtin:([0-9]{6})\\.([0-9]{1})([0-9]{6})\\.([!%-?A-Z_a-z\\x22]{1,20})$") };

	public static final Pattern[] GTINList = new Pattern[] {
			Pattern.compile("^urn:epc:idpat:sgtin:([0-9]{12})\\.([0-9]{1})()\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:sgtin:([0-9]{11})\\.([0-9]{1})([0-9]{1})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:sgtin:([0-9]{10})\\.([0-9]{1})([0-9]{2})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:sgtin:([0-9]{9})\\.([0-9]{1})([0-9]{3})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:sgtin:([0-9]{8})\\.([0-9]{1})([0-9]{4})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:sgtin:([0-9]{7})\\.([0-9]{1})([0-9]{5})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:sgtin:([0-9]{6})\\.([0-9]{1})([0-9]{6})\\.\\*$") };

	public static final Pattern[] LGTINList = new Pattern[] {
			Pattern.compile("^urn:epc:class:lgtin:([0-9]{12})\\.([0-9]{1})()\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:class:lgtin:([0-9]{11})\\.([0-9]{1})([0-9]{1})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:class:lgtin:([0-9]{10})\\.([0-9]{1})([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:class:lgtin:([0-9]{9})\\.([0-9]{1})([0-9]{3})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:class:lgtin:([0-9]{8})\\.([0-9]{1})([0-9]{4})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile("^urn:epc:class:lgtin:([0-9]{7})\\.([0-9]{1})([0-9]{5})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
	...
	public static final Pattern[] SSCCList = new Pattern[] {
			...
			Pattern.compile("^urn:epc:id:sscc:([0-9]{11})\\.([0-9]{1})([0-9]{5})$"),
			Pattern.compile("^urn:epc:id:sscc:([0-9]{10})\\.([0-9]{1})([0-9]{6})$"),
			Pattern.compile("^urn:epc:id:sscc:([0-9]{9})\\.([0-9]{1})([0-9]{7})$"),
			Pattern.compile("^urn:epc:id:sscc:([0-9]{8})\\.([0-9]{1})([0-9]{8})$"),
			Pattern.compile("^urn:epc:id:sscc:([0-9]{7})\\.([0-9]{1})([0-9]{9})$"),
			Pattern.compile("^urn:epc:id:sscc:([0-9]{6})\\.([0-9]{1})([0-9]{10})$") };
	...
	public static final Pattern[] ITIPList = new Pattern[] { Pattern.compile(
			"^urn:epc:id:itip:([0-9]{12})\\.([0-9]{1})([0-9]{0})\\.([0-9]{2})\\.([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile(
					"^urn:epc:id:itip:([0-9]{11})\\.([0-9]{1})([0-9]{1})\\.([0-9]{2})\\.([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile(
					"^urn:epc:id:itip:([0-9]{10})\\.([0-9]{1})([0-9]{2})\\.([0-9]{2})\\.([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile(
					"^urn:epc:id:itip:([0-9]{9})\\.([0-9]{1})([0-9]{3})\\.([0-9]{2})\\.([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile(
					"^urn:epc:id:itip:([0-9]{8})\\.([0-9]{1})([0-9]{4})\\.([0-9]{2})\\.([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile(
					"^urn:epc:id:itip:([0-9]{7})\\.([0-9]{1})([0-9]{5})\\.([0-9]{2})\\.([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$"),
			Pattern.compile(
					"^urn:epc:id:itip:([0-9]{6})\\.([0-9]{1})([0-9]{6})\\.([0-9]{2})\\.([0-9]{2})\\.([!%-?A-Z_a-z\\x22]{1,20})$") };

	public static final Pattern[] cITIPList = new Pattern[] {
			Pattern.compile("^urn:epc:idpat:itip:([0-9]{12})\\.([0-9]{1})([0-9]{0})\\.([0-9]{2})\\.([0-9]{2})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:itip:([0-9]{11})\\.([0-9]{1})([0-9]{1})\\.([0-9]{2})\\.([0-9]{2})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:itip:([0-9]{10})\\.([0-9]{1})([0-9]{2})\\.([0-9]{2})\\.([0-9]{2})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:itip:([0-9]{9})\\.([0-9]{1})([0-9]{3})\\.([0-9]{2})\\.([0-9]{2})\\.\\*"),
			Pattern.compile("^urn:epc:idpat:itip:([0-9]{8})\\.([0-9]{1})([0-9]{4})\\.([0-9]{2})\\.([0-9]{2})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:itip:([0-9]{7})\\.([0-9]{1})([0-9]{5})\\.([0-9]{2})\\.([0-9]{2})\\.\\*$"),
			Pattern.compile("^urn:epc:idpat:itip:([0-9]{6})\\.([0-9]{1})([0-9]{6})\\.([0-9]{2})\\.([0-9]{2})\\.\\*$") };
