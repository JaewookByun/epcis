 ...
 *
 * The mass of the consistutent (or solute) divided by the volume of the mixture
 * (or solvent). SI Units: kilogram per cubic metre gs1:MassConcentration
 *
 ...
 */
public class MassConcentration extends Unit {
	...
	public MassConcentration(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public MassConcentration(String uom, Double value) {
