 ...
 *
 * Rate of flow of charge in a substance, whether solid, liquid or gas. SI
 * Units: ampere gs1:ElectricCurrent
 *
 ...
 */
public class ElectricCurrent extends Unit {
	...
	public ElectricCurrent(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public ElectricCurrent(String uom, Double value) {
