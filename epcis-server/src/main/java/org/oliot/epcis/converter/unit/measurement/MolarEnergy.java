 ...
 *
 * The ratio of the thermodynamic energy of a chemical compound to the amount of
 * substance (atoms or molecules) contained within it, the amount of substance
 * being measured in moles. SI Units: joule per mole gs1:MolarEnergy
 *
 ...
 */
public class MolarEnergy extends Unit {
	...
	public MolarEnergy(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public MolarEnergy(String uom, Double value) {
