 ...
 *
 * The ratio of the partial pressure of water vapour in an an air-water mixture
 * to the saturated vapour pressure of water at a prescribed temperature.
 * Typically expressed as a percentage. gs1:RelativeHumidity
 *
 ...
 */
public class RelativeHumidity extends Unit {
	...
	public RelativeHumidity(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public RelativeHumidity(String uom, Double value) {
