 ...
 *
 * The ratio of the mass of a chemical compound to the amount of substance
 * (atoms or molecules) contained within it, the amount of substance being
 * measured in moles. SI Units: kilogram per mole gs1:MolarMass
 *
 ...
 */
public class MolarMass extends Unit {
