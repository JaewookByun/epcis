 ...
 *
 * The energy in the form of visible radiation reaching a surface per unit area
 * in unit time; the amount of luminous flux per unit area. SI Units: lux = 1
 * lumen per square metre gs1:Illuminance
 *
 ...
 */
public class Illuminance extends Unit {
