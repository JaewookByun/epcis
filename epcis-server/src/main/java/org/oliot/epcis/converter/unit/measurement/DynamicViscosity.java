 ...
 *
 * The value of the tangential force per unit area which is necessary to
 * maintain unit relative velocty between two parallel planes unit distance
 * apart in a fluid. SI Units: pascal gs1:DynamicViscosity
 *
 ...
 */
public class DynamicViscosity extends Unit {
	...
	public DynamicViscosity(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public DynamicViscosity(String uom, Double value) {
