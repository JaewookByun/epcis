 ...
 *
 * The energy absorbed per unit mass of the patient from the decay of a
 * radionuclide given to a patient for diagnostic or therapeutic purposes. SI
 * Units: gray gs1:AbsorbedDose
 *
 *
