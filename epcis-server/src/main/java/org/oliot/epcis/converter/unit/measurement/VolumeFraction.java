 ...
 *
 * The dimensionless ratio of a volume of one substance to the volume of solid,
 * liquid or gas in which it is contained. Typical units: parts per million,
 * parts per billion, etc. gs1:VolumeFraction
 *
 ...
 */
public class VolumeFraction extends Unit {
	...
	public VolumeFraction(Type type, Double value) {
		this.type = type;
		this.uom = type.toString();
		this.value = value;
	}

	public VolumeFraction(String uom, Double value) {
