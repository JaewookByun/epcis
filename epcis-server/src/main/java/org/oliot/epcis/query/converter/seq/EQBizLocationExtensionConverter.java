 ...
 * 
 */
public class EQBizLocationExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getEQExtensionQuery("bizLocationExt." + retrieveParameterType(key, 15), value);
	}
}
