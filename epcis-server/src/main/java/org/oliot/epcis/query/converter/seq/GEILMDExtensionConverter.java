 ...
 * 
 */
public class GEILMDExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		
		return getComparisonExtensionQuery("ilmd." + retrieveParameterType(key, 8), "$gte", value);
