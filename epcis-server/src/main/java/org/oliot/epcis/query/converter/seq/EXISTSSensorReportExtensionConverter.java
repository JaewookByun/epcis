 ...
 * 
 */
public class EXISTSSensorReportExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getExistsQuery("sensorElementList.sensorReport.otherAttributes." + retrieveParameterType(key, 20));
	}
}
