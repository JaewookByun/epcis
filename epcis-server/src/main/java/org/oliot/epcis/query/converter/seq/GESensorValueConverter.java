 ...
 * 
 */
public class GESensorValueConverter extends BaseConverter implements QueryConverter {
	...
	public Document convert(String key, Object value) throws QueryParameterException {
		...
		return new Document().append("sensorElementList.sensorReport.rUom", rUom)
				.append("sensorElementList.sensorReport.rValue", new Document("$gte", rValue));
	}
}
