 ...
 * 
 */
public class EQSensorReportExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getEQExtensionQuery("sensorElementList.sensorReport.otherAttributes." + retrieveParameterType(key, 16), value);
	}
}
