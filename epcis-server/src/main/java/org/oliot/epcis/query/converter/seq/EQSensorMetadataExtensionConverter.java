 ...
 * 
 */
public class EQSensorMetadataExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getEQExtensionQuery("sensorElementList.sensorMetadata.otherAttributes." + retrieveParameterType(key, 18), value);
	}
}
