 ...
 * 
 */
public class LTReadPointInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {

		return getComparisonExtensionQuery("rpf." + retrieveParameterType(key, 19), "$lt", value);
