 ...
 * 
 */
public class EXISTSSensorMetadataExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getExistsQuery("sensorElementList.sensorMetadata.otherAttributes." + retrieveParameterType(key, 22));
	}
}
