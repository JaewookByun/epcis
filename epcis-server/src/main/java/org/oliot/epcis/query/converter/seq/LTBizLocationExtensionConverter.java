 ...
 * 
 */
public class LTBizLocationExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {

		return getComparisonExtensionQuery("bizLocationExt." + retrieveParameterType(key, 15), "$lt", value);
