 ...
 * 
 */
public class LESensorSDevConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		double dValue = getDouble(value);
		String uom = retrieveParameterType(key, 8);
		...
		return new Document().append("sensorElementList.sensorReport.rUom", rUom)
				.append("sensorElementList.sensorReport.rSDev", new Document("$lte", rValue));
	}
}
