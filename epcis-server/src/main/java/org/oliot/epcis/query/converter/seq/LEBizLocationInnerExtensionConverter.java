 ...
 * 
 */
public class LEBizLocationInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		
		return getComparisonExtensionQuery("blf." + retrieveParameterType(key, 21), "$lte", value);
