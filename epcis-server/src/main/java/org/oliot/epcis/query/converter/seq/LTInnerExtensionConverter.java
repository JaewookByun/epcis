 ...
 * 
 */
public class LTInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {

		return getComparisonExtensionQuery("extf." + retrieveParameterType(key, 9), "$lt", value);
