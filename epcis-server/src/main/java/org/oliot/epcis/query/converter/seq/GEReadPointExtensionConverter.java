 ...
 * 
 */
public class GEReadPointExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		
		return getComparisonExtensionQuery("readPointExt." + retrieveParameterType(key, 13), "$gte", value);
