 ...
 * 
 */
public class GEBizLocationExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		
		return getComparisonExtensionQuery("bizLocationExt." + retrieveParameterType(key, 15), "$gte", value);
