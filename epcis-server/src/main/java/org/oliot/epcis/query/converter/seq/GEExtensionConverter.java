 ...
 * 
 */
public class GEExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		
		return getComparisonExtensionQuery("extension." + retrieveParameterType(key, 3), "$gte", value);
