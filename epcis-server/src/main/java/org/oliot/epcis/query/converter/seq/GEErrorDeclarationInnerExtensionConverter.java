 ...
 * 
 */
public class GEErrorDeclarationInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {

		return getComparisonExtensionQuery("errf." + retrieveParameterType(key, 27), "$gte", value);
