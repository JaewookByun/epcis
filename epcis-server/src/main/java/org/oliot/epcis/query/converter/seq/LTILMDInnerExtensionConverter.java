 ...
 * 
 */
public class LTILMDInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {

		return getComparisonExtensionQuery("ilmdf." + retrieveParameterType(key, 14), "$lt", value);
