 ...
 * 
 */
public class GTSensorElementInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		
		return getComparisonExtensionQuery("sensorElementList.sef." + retrieveParameterType(key, 23), "$gt", value);
