 ...
 * 
 */
public class GESensorMinValueConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		double dValue = getDouble(value);
		String uom = retrieveParameterType(key, 12);
		...
		return new Document().append("sensorElementList.sensorReport.rUom", rUom)
				.append("sensorElementList.sensorReport.rMinValue", new Document("$gte", rValue));
	}
}
