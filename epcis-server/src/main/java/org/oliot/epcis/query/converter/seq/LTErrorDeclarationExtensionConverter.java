 ...
 * 
 */
public class LTErrorDeclarationExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {

		return getComparisonExtensionQuery("errorDeclaration.extension." + retrieveParameterType(key, 21), "$lt", value);
