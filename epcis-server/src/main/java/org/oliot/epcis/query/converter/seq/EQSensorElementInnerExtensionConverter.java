 ...
 * 
 */
public class EQSensorElementInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getEQExtensionQuery("sensorElementList.sef." + retrieveParameterType(key, 23), value);
	}
}
