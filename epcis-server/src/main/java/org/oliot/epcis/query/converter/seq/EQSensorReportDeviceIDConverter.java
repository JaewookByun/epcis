 ...
 * 
 */
public class EQSensorReportDeviceIDConverter extends BaseConverter implements QueryConverter {
	...
	public Document convert(String key, Object value) throws QueryParameterException {
		...
		return getEQQuery("sensorElementList.sensorReport.deviceID", valueList);
	}
}
