 ...
 * 
 */
public class EQErrorDeclarationExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getEQExtensionQuery("errorDeclaration.extension." + retrieveParameterType(key, 21), value);
	}
}
