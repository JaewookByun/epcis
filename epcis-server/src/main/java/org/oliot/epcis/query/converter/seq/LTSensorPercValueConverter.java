 ...
 * 
 */
public class LTSensorPercValueConverter extends BaseConverter implements QueryConverter {
	...
	public Document convert(String key, Object value) throws QueryParameterException {
		...
		return new Document().append("sensorElementList.sensorReport.rUom", rUom)
				.append("sensorElementList.sensorReport.rPercValue", new Document("$lt", rValue));
	}
}
