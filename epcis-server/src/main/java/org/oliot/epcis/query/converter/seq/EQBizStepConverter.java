...
public class EQBizStepConverter extends BaseConverter implements QueryConverter {
	...
	public Document convert(String key, Object value) throws QueryParameterException {
		...
		if (!valueList.parallelStream().allMatch(StaticResource.bizSteps::contains))
			throw new QueryParameterException("the value of a parameter should be one of " + StaticResource.bizSteps);
