 ...
 * 
 */
public class GTSensorElementExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		
		return getComparisonExtensionQuery("sensorElementList.extension." + retrieveParameterType(key, 17), "$gt", value);
