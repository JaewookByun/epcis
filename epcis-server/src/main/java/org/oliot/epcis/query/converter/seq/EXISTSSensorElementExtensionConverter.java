 ...
 * 
 */
public class EXISTSSensorElementExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getExistsQuery("sensorElementList.extension." + retrieveParameterType(key, 21));
	}
}
