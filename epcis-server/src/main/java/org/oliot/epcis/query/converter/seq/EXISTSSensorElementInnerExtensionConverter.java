 ...
 * 
 */
public class EXISTSSensorElementInnerExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getExistsQuery("sensorElementList.sef." + retrieveParameterType(key, 27));
	}
}
