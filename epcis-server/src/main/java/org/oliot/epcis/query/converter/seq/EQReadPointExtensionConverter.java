 ...
 * 
 */
public class EQReadPointExtensionConverter extends BaseConverter implements QueryConverter {

	@Override
	public Document convert(String key, Object value) throws QueryParameterException {
		return getEQExtensionQuery("readPointExt." + retrieveParameterType(key, 13), value);
	}
}
