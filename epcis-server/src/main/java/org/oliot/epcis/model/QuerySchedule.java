 ...
 *         &lt;element name="extension" type="{urn:epcglobal:epcis-query:xsd:2}QueryScheduleExtensionType" minOccurs="0"/>
...
@XmlType(name = "QuerySchedule", namespace = "urn:epcglobal:epcis-query:xsd:2", propOrder = { "second", "minute",
...
public class QuerySchedule {
	 ...
	 * 
	 * @param value allowed object is {@link QueryScheduleExtensionType }
	 * 
	 */
