 ...
 *         bjw0829@gmail.com
 */
public class ResourcePageExpiryTimerTask extends TimerTask {
	private String targetAPI;
	private ConcurrentHashMap<UUID, ResourcePage> pageMap;
	private UUID uuidToRemove;
	private Logger logger;

	public ResourcePageExpiryTimerTask(String targetAPI, ConcurrentHashMap<UUID, ResourcePage> pageMap, UUID uuidToRemove,
			Logger logger) {
