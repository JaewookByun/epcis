...
// Generated on: 2014.08.30 at 12:36:33 PM KST 
//
 ...
 *   &lt;complexContent>
 *     &lt;extension base="{epcis.oliot.org}EPCISEventType">
 *       &lt;sequence>
 *         &lt;element name="inputEPCList" type="{epcis.oliot.org}EPCListType" minOccurs="0"/>
 *         &lt;element name="inputQuantityList" type="{epcis.oliot.org}QuantityListType" minOccurs="0"/>
 *         &lt;element name="outputEPCList" type="{epcis.oliot.org}EPCListType" minOccurs="0"/>
 *         &lt;element name="outputQuantityList" type="{epcis.oliot.org}QuantityListType" minOccurs="0"/>
 *         &lt;element name="transformationID" type="{epcis.oliot.org}TransformationIDType" minOccurs="0"/>
 *         &lt;element name="bizStep" type="{epcis.oliot.org}BusinessStepIDType" minOccurs="0"/>
 *         &lt;element name="disposition" type="{epcis.oliot.org}DispositionIDType" minOccurs="0"/>
 *         &lt;element name="readPoint" type="{epcis.oliot.org}ReadPointType" minOccurs="0"/>
 *         &lt;element name="bizLocation" type="{epcis.oliot.org}BusinessLocationType" minOccurs="0"/>
 *         &lt;element name="bizTransactionList" type="{epcis.oliot.org}BusinessTransactionListType" minOccurs="0"/>
 *         &lt;element name="sourceList" type="{epcis.oliot.org}SourceListType" minOccurs="0"/>
 *         &lt;element name="destinationList" type="{epcis.oliot.org}DestinationListType" minOccurs="0"/>
 *         &lt;element name="ilmd" type="{epcis.oliot.org}ILMDType" minOccurs="0"/>
 *         &lt;element name="extension" type="{epcis.oliot.org}TransformationEventExtensionType" minOccurs="0"/>
