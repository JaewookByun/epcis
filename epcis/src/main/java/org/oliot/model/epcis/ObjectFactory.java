...
public class ObjectFactory {
	...
	private final static QName _EPCISDocument_QNAME = new QName(
			"epcis.oliot.org", "EPCISDocument");
	private final static QName _EventListTypeExtension_QNAME = new QName("",
			"extension");
	private final static QName _EventListTypeTransactionEvent_QNAME = new QName(
			"", "TransactionEvent");
	private final static QName _EventListTypeObjectEvent_QNAME = new QName("",
			"ObjectEvent");
	private final static QName _EventListTypeQuantityEvent_QNAME = new QName(
			"", "QuantityEvent");
	private final static QName _EventListTypeAggregationEvent_QNAME = new QName(
			"", "AggregationEvent");
	private final static QName _EventListTypeTransformationEvent_QNAME = new QName(
			"", "TransformationEvent");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: org.oliot.epcis.model
	 * 
	 */
	...
	public JAXBElement<Object> createScopeInformation(Object value) {
		return new JAXBElement<Object>(_ScopeInformation_QNAME, Object.class,
				null, value);
	}
	...
	public JAXBElement<CorrelationInformation> createCorrelationInformation(
			CorrelationInformation value) {
		return new JAXBElement<CorrelationInformation>(
				_CorrelationInformation_QNAME, CorrelationInformation.class,
				null, value);
	}
	...
	public JAXBElement<StandardBusinessDocumentHeader> createStandardBusinessDocumentHeader(
		...
		return new JAXBElement<StandardBusinessDocumentHeader>(
	...
	public JAXBElement<BusinessService> createBusinessService(
			BusinessService value) {
		return new JAXBElement<BusinessService>(_BusinessService_QNAME,
				BusinessService.class, null, value);
	}
	...
	public JAXBElement<StandardBusinessDocument> createStandardBusinessDocument(
			StandardBusinessDocument value) {
		return new JAXBElement<StandardBusinessDocument>(
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "epcis.oliot.org", name = "EPCISDocument")
	public JAXBElement<EPCISDocumentType> createEPCISDocument(
			EPCISDocumentType value) {
		return new JAXBElement<EPCISDocumentType>(_EPCISDocument_QNAME,
				EPCISDocumentType.class, null, value);
	}
	...
	public JAXBElement<EPCISEventListExtensionType> createEventListTypeExtension(
			EPCISEventListExtensionType value) {
		return new JAXBElement<EPCISEventListExtensionType>(
				_EventListTypeExtension_QNAME,
	...
	public JAXBElement<TransactionEventType> createEventListTypeTransactionEvent(
			TransactionEventType value) {
		return new JAXBElement<TransactionEventType>(
				_EventListTypeTransactionEvent_QNAME,
				TransactionEventType.class, EventListType.class, value);
	}
	...
	public JAXBElement<ObjectEventType> createEventListTypeObjectEvent(
			ObjectEventType value) {
		return new JAXBElement<ObjectEventType>(
				_EventListTypeObjectEvent_QNAME, ObjectEventType.class,
	...
	public JAXBElement<QuantityEventType> createEventListTypeQuantityEvent(
			QuantityEventType value) {
		return new JAXBElement<QuantityEventType>(
				_EventListTypeQuantityEvent_QNAME, QuantityEventType.class,
				EventListType.class, value);
	}
	...
	public JAXBElement<AggregationEventType> createEventListTypeAggregationEvent(
			AggregationEventType value) {
		return new JAXBElement<AggregationEventType>(
				_EventListTypeAggregationEvent_QNAME,
				AggregationEventType.class, EventListType.class, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link TransformationEventType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "TransformationEvent", scope = EventListType.class)
	public JAXBElement<TransformationEventType> createEventListTypeTransformationEvent(
			TransformationEventType value) {
		return new JAXBElement<TransformationEventType>(
				_EventListTypeTransformationEvent_QNAME,
				TransformationEventType.class, EventListType.class, value);
	}
