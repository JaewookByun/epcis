 ...
 *         &lt;element name="baseExtension" type="{epcis.oliot.org}EPCISEventExtensionType" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "EPCISEventType", propOrder = { "eventTime", "recordTime",
		"eventTimeZoneOffset", "baseExtension" })
@XmlSeeAlso({ QuantityEventType.class, AggregationEventType.class,
		TransformationEventType.class, TransactionEventType.class,
