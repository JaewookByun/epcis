 ...
 *       &lt;sequence>
 *         &lt;element name="bizTransactionList" type="{epcis.oliot.org}BusinessTransactionListType"/>
 *         &lt;element name="parentID" type="{epcis.oliot.org}ParentIDType" minOccurs="0"/>
 *         &lt;element name="epcList" type="{epcis.oliot.org}EPCListType"/>
 *         &lt;element name="action" type="{epcis.oliot.org}ActionType"/>
 ...
 *         &lt;element name="extension" type="{epcis.oliot.org}TransactionEventExtensionType" minOccurs="0"/>
...
@XmlType(name = "TransactionEventType", propOrder = { "bizTransactionList",
		"parentID", "epcList", "action", "bizStep", "disposition", "readPoint",
		"bizLocation", "extension", "any" })
