...
public class EventListType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private org.oliot.epcis.ObjectEventType[] objectEvent;

    private org.oliot.epcis.AggregationEventType[] aggregationEvent;

    private org.oliot.epcis.QuantityEventType[] quantityEvent;

    private org.oliot.epcis.TransactionEventType[] transactionEvent;

    private org.oliot.epcis.EPCISEventListExtensionType extension;
    ...
    public EventListType(
           org.oliot.epcis.ObjectEventType[] objectEvent,
           org.oliot.epcis.AggregationEventType[] aggregationEvent,
           org.oliot.epcis.QuantityEventType[] quantityEvent,
           org.oliot.epcis.TransactionEventType[] transactionEvent,
           org.oliot.epcis.EPCISEventListExtensionType extension,
     ...
     * @return objectEvent
     */
    public org.oliot.epcis.ObjectEventType[] getObjectEvent() {
        return objectEvent;
    }
     ...
     * @param objectEvent
     */
    public void setObjectEvent(org.oliot.epcis.ObjectEventType[] objectEvent) {
        this.objectEvent = objectEvent;
    }

    public org.oliot.epcis.ObjectEventType getObjectEvent(int i) {
        return this.objectEvent[i];
    }

    public void setObjectEvent(int i, org.oliot.epcis.ObjectEventType _value) {
     ...
     */
    public org.oliot.epcis.AggregationEventType[] getAggregationEvent() {
        return aggregationEvent;
    }
     ...
     */
    public void setAggregationEvent(org.oliot.epcis.AggregationEventType[] aggregationEvent) {
        this.aggregationEvent = aggregationEvent;
    }

    public org.oliot.epcis.AggregationEventType getAggregationEvent(int i) {
        return this.aggregationEvent[i];
    }

    public void setAggregationEvent(int i, org.oliot.epcis.AggregationEventType _value) {
     ...
     */
    public org.oliot.epcis.QuantityEventType[] getQuantityEvent() {
        return quantityEvent;
    }
     ...
     * @param quantityEvent
     */
    public void setQuantityEvent(org.oliot.epcis.QuantityEventType[] quantityEvent) {
        this.quantityEvent = quantityEvent;
    }

    public org.oliot.epcis.QuantityEventType getQuantityEvent(int i) {
        return this.quantityEvent[i];
    }

    public void setQuantityEvent(int i, org.oliot.epcis.QuantityEventType _value) {
