...
public class TransactionEventExtensionType  implements Serializable {
	...
	public TransactionEventExtensionType(	QuantityElementType[] quantityList,	SourceDestType[] sourceList,
			SourceDestType[] destinationList,	TransactionEventExtension2Type extension) {
	 ...
	 * @return extension
	 */
	public org.oliot.epcis.TransactionEventExtension2Type getExtension() {
		return extension;
	}
	 ...
	 * @param extension
	 */
	public void setExtension(org.oliot.epcis.TransactionEventExtension2Type extension) {
		this.extension = extension;
	}
	...
	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("epcis.oliot.org", "TransactionEventExtensionType"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("epcis.oliot.org", "TransactionEventExtension2Type"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
	}
