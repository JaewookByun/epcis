...
public class ObjectEventExtensionType  implements java.io.Serializable {
    ...
    private org.oliot.epcis.axis.ObjectEventExtension2Type extension;
    ...
    public ObjectEventExtensionType(
           ...
           org.oliot.epcis.axis.ObjectEventExtension2Type extension) {
     ...
     * @return extension
     */
    public org.oliot.epcis.axis.ObjectEventExtension2Type getExtension() {
        return extension;
    }
     ...
     * @param extension
     */
    public void setExtension(org.oliot.epcis.axis.ObjectEventExtension2Type extension) {
        this.extension = extension;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("axis.epcis.oliot.org", "ObjectEventExtensionType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("axis.epcis.oliot.org", "ObjectEventExtension2Type"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
