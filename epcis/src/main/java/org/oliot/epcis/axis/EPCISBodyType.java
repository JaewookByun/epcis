...
public class EPCISBodyType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    private org.oliot.epcis.axis.EPCISBodyExtensionType extension;
    ...
    public EPCISBodyType(
           ...
           org.oliot.epcis.axis.EPCISBodyExtensionType extension,
     ...
     * @return extension
     */
    public org.oliot.epcis.axis.EPCISBodyExtensionType getExtension() {
        return extension;
    }
     ...
     * @param extension
     */
    public void setExtension(org.oliot.epcis.axis.EPCISBodyExtensionType extension) {
        this.extension = extension;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("axis.epcis.oliot.org", "EPCISBodyType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("axis.epcis.oliot.org", "EPCISBodyExtensionType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
