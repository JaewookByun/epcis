...
public class Manifest  implements java.io.Serializable {
    ...
    private org.oliot.epcis.axis.ManifestItem[] manifestItem;
    ...
    public Manifest(
           ...
           org.oliot.epcis.axis.ManifestItem[] manifestItem) {
     ...
     * @return manifestItem
     */
    public org.oliot.epcis.axis.ManifestItem[] getManifestItem() {
        return manifestItem;
    }
     ...
     * @param manifestItem
     */
    public void setManifestItem(org.oliot.epcis.axis.ManifestItem[] manifestItem) {
        this.manifestItem = manifestItem;
    }

    public org.oliot.epcis.axis.ManifestItem getManifestItem(int i) {
        return this.manifestItem[i];
    }

    public void setManifestItem(int i, org.oliot.epcis.axis.ManifestItem _value) {
