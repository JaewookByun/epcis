...
public class ObjectEventExtension2Type  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("axis.epcis.oliot.org", "ObjectEventExtension2Type"));
    }
