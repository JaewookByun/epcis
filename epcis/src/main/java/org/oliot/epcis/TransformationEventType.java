...
public class TransformationEventType  extends EPCISEventType  implements Serializable, AnyContentType {
	...
	public TransformationEventType(	Calendar eventTime,Calendar recordTime,String eventTimeZoneOffset,
			EPCISEventExtensionType baseExtension,EPC[] inputEPCList,QuantityElementType[] inputQuantityList,
			EPC[] outputEPCList,QuantityElementType[] outputQuantityList,URI transformationID,
			URI bizStep,URI disposition,ReadPointType readPoint,BusinessLocationType bizLocation,
			BusinessTransactionType[] bizTransactionList,	SourceDestType[] sourceList,
			SourceDestType[] destinationList,ILMDType ilmd,TransformationEventExtensionType extension,
			MessageElement [] _any) {
		super(
				eventTime,
				recordTime,
