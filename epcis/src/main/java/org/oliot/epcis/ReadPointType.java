...
public class ReadPointType  implements Serializable, AnyContentType {
	...
	public ReadPointType(URI id,ReadPointExtensionType extension,MessageElement [] _any) {
		this.id = id;
	 ...
	 * @return extension
	 */
	public org.oliot.epcis.ReadPointExtensionType getExtension() {
		return extension;
	}
	 ...
	 * @param extension
	 */
	public void setExtension(org.oliot.epcis.ReadPointExtensionType extension) {
		this.extension = extension;
	}
	...
	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("epcis.oliot.org", "ReadPointType"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("epcis.oliot.org", "ReadPointExtensionType"));
