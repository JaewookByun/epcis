...
public class ObjectEventType  extends EPCISEventType  implements Serializable, AnyContentType {
	...
	public ObjectEventType( Calendar eventTime,Calendar recordTime,String eventTimeZoneOffset,
			EPCISEventExtensionType baseExtension,	EPC[] epcList,ActionType action,
			URI bizStep,	URI disposition,	ReadPointType readPoint,	BusinessLocationType bizLocation,
			BusinessTransactionType[] bizTransactionList,	ObjectEventExtensionType extension,
			MessageElement [] _any) {
		super(
				eventTime,
				recordTime,
