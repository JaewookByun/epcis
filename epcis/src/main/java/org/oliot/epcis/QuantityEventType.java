...
public class QuantityEventType  extends EPCISEventType  implements Serializable, AnyContentType {
	...
	public QuantityEventType(Calendar eventTime,	Calendar recordTime,	String eventTimeZoneOffset,
			EPCISEventExtensionType baseExtension,	URI epcClass,	int quantity,	URI bizStep,
			URI disposition,	ReadPointType readPoint,	BusinessLocationType bizLocation,
			BusinessTransactionType[] bizTransactionList,	QuantityEventExtensionType extension,
			MessageElement [] _any) {
		super(
				eventTime,
				recordTime,
	 ...
	 * @return extension
	 */
	public org.oliot.epcis.QuantityEventExtensionType getExtension() {
		return extension;
	}
	 ...
	 * @param extension
	 */
	public void setExtension(org.oliot.epcis.QuantityEventExtensionType extension) {
		this.extension = extension;
	}
	...
	static {
		typeDesc.setXmlType(new javax.xml.namespace.QName("epcis.oliot.org", "QuantityEventType"));
		...
		elemField.setXmlType(new javax.xml.namespace.QName("epcis.oliot.org", "QuantityEventExtensionType"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
	}
