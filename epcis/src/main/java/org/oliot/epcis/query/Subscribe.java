...
public class Subscribe  implements java.io.Serializable {
    ...
    private org.oliot.epcis.query.SubscriptionControls controls;
    ...
    public Subscribe(
           ...
           org.oliot.epcis.query.SubscriptionControls controls,
     ...
     * @return controls
     */
    public org.oliot.epcis.query.SubscriptionControls getControls() {
        return controls;
    }
     ...
     * @param controls
     */
    public void setControls(org.oliot.epcis.query.SubscriptionControls controls) {
        this.controls = controls;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("query.epcis.oliot.org", "Subscribe"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("query.epcis.oliot.org", "SubscriptionControls"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
