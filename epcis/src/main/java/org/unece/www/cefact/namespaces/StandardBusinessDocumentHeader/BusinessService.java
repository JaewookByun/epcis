...
public class BusinessService  implements java.io.Serializable {
    ...
    private org.unece.www.cefact.namespaces.StandardBusinessDocumentHeader.ServiceTransaction serviceTransaction;
    ...
    public BusinessService(
           ...
           org.unece.www.cefact.namespaces.StandardBusinessDocumentHeader.ServiceTransaction serviceTransaction) {
     ...
     */
    public org.unece.www.cefact.namespaces.StandardBusinessDocumentHeader.ServiceTransaction getServiceTransaction() {
        return serviceTransaction;
    }
     ...
     */
    public void setServiceTransaction(org.unece.www.cefact.namespaces.StandardBusinessDocumentHeader.ServiceTransaction serviceTransaction) {
        this.serviceTransaction = serviceTransaction;
    }
