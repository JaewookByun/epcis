...
static Element putAny(Map<Integer, ExtensionMap> map, int left,int[] level, Element element, List<Object> elementList,Document doc) throws ParserConfigurationException{ //, Element element, Boolean parent
		...
		try{
			if(type!=null){
				if(type.equals("int")){
					...
					if(extensionMap.getBoleanValue()==1){
						value="true";
					}else{
						value="fale";
					}
	...
	public static void extensionHierarchCriteria_EQ_qName(Criteria criteria, String qName, String alias, int isInner){
		try{
	...
	public static void extensionHierarchCriteria_EQ(Criteria criteria, List<PairType> ValueTypeList, String qName, String alias, int isInner){
		try{
	...
	public static void extensionHierarchCriteria_GT(Criteria criteria, List<PairType> ValueTypeList, String qName, String alias, int isInner){
		try{
			 for(int i=0; i<ValueTypeList.size(); i++){
			    	String dataType=ValueTypeList.get(i).getType();
			    	if(dataType.equals("int")){
	...
	public static void extensionHierarchCriteria_LT(Criteria criteria, List<PairType> ValueTypeList, String qName, String alias, int isInner){
		try{
			 for(int i=0; i<ValueTypeList.size(); i++){
			    	String dataType=ValueTypeList.get(i).getType();
			    	if(dataType.equals("int")){
	...
	public static void extensionHierarchCriteria_GE(Criteria criteria, List<PairType> ValueTypeList, String qName, String alias, int isInner){
		try{
			 for(int i=0; i<ValueTypeList.size(); i++){
			    	String dataType=ValueTypeList.get(i).getType();
			    	if(dataType.equals("int")){
	...
	public static void extensionHierarchCriteria_LE(Criteria criteria, List<PairType> ValueTypeList, String qName, String alias, int isInner){
		try{
			 for(int i=0; i<ValueTypeList.size(); i++){
			    	String dataType=ValueTypeList.get(i).getType();
			    	if(dataType.equals("int")){
