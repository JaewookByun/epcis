...
public class ObjectEventExtension2 {
	...
	//@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="objecteventextension2_seq")
	//@SequenceGenerator(name="objecteventextension2_seq", sequenceName="objecteventextension2_seq", allocationSize=1)
	private int id;
