...
public class ReadPointExtension {
    ...
    //@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="readpointextension_seq")
	//@SequenceGenerator(name="readpointextension_seq", sequenceName="readpointextension_seq", allocationSize=1)
    private int id;
