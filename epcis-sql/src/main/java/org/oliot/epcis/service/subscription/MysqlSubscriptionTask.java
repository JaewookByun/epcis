...
//
	...
	public void execute(JobExecutionContext context)
		...
		String EQ_eventID= map.getString("EQ_eventID"); 
		String EXISTS_errorDeclaration = map.getString("EXISTS_errorDeclaration"); 
		String GE_errorDeclarationTime = map.getString("GE_errorDeclarationTime");
		String LT_errorDeclarationTime = map.getString("GE_errorDeclarationTime");
		String EQ_errorReason = map.getString("EQ_errorReason");
		String EQ_correctiveEventID = map.getString("EQ_correctiveEventID");
