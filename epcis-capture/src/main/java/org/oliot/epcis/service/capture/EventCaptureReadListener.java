...
class EventCaptureReadListener implements ReadListener {
	...
	EventCaptureReadListener(ServletInputStream in, HttpServletResponse r, AsyncContext c) {
		input = in;
		res = r;
		ac = c;
	}
