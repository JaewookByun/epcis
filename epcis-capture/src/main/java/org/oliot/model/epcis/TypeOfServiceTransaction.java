...
/**
 * <p>
 * TypeOfServiceTransaction에 대한 Java 클래스입니다.
 * 
 * <p>
...
public enum TypeOfServiceTransaction {
	...
	@XmlEnumValue("RequestingServiceTransaction") REQUESTING_SERVICE_TRANSACTION(
			"RequestingServiceTransaction"), @XmlEnumValue("RespondingServiceTransaction") RESPONDING_SERVICE_TRANSACTION(
