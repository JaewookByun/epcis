...
<body>
		...
		<div class="col-md-4">
			<div class="list-group">
				<a href="#" class="list-group-item active"
					...
					describes the transformation from input-object(s) to
	...
	<script>
		...
		$("#transaction").load("./exampleXML/Demo/example3.xml",
			...
			$("#transaction").load("./exampleXML/Demo/example3.xml",
					function(responseTxt, statusTxt, xhr) {
						...
						$.ajax({
							...
							document.location.href = "./captureService4.jsp";
						});
					});
		}
