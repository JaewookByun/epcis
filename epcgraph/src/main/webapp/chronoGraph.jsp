...
<%
	...
	CachedTraversalEngine e = new CachedTraversalEngine(g.getChronoVertex("0"),true,false,CachedChronoVertex.class);
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<input id="consoleMsg" type="text" class="form-control" disabled
						placeholder="Message from Facebook"> <br>
					<p>Facebook ID</p>
					...
					<input id="fAccessToken" type="text" class="form-control"
						placeholder="Access Token will be shown here"> <br>
					...
					<br>
					<button type="button" class="btn btn-danger" onclick="resetDB()">Reset
						DB</button>
				</div>
			</div>
		</div>
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-sm-12">
					...
					<p>2.2.1. The condition of 2.2 is to be a member of Facebook ID
						via the login button here.</p>
					<p>2.2.2. If the application is still 'test' one, the
						administrator should register friends as tester</p>
					<p>3. Try
