...
public class OrientTraversalEngine {
	...
	private final OrientGraphNoTx g;
	 ...
	 */
	public OrientTraversalEngine(final OrientGraphNoTx g, final Object starts, final boolean setParallel,
		...
		if (starts instanceof Stream) {
			...
			if (setPathEnabled) {
				...
				|| starts instanceof VertexEvent || starts instanceof EdgeEvent || starts instanceof Vertex) {
	...
	private OrientTraversalEngine(final OrientGraphNoTx g, final Object starts, final boolean setParallel,
	 ...
	 */
	public OrientTraversalEngine V() {
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine E() {
		// Check Input element class
		checkInputElementClass(ChronoGraph.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine V(final String key, final Object value) {
		// Check Input element class
		checkInputElementClass(ChronoGraph.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine E(final String key, final Object value) {
		// Check Input element class
		checkInputElementClass(ChronoGraph.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine bothE(final BsonArray labels, final int branchFactor) {
		// Check Input element class
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine outE(final BsonArray labels, final int branchFactor) {
		// Check Input element class
		// checkInputElementClass(ChronoVertex.class);
		...
		if (isPathEnabled) {
			...
			Map intermediate = (Map) stream.map(v -> {
				...
				Iterator<Edge> iter = cv.getEdges(Direction.OUT).iterator();
			
				while(iter.hasNext()) {
					newSet.add(iter.next());
				}
				
				return new AbstractMap.SimpleImmutableEntry(cv, newSet);
			}).collect(Collectors.toMap(e -> ((Entry) e).getKey(), e -> ((Entry) e).getValue()));
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine inE(final BsonArray labels, final int branchFactor) {
		// Check Input element class
		checkInputElementClass(ChronoVertex.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine bothV() {
		// Check Input element class
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine outV() {
		// Check Input element class
		checkInputElementClass(ChronoEdge.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine inV() {
		// Check Input element class
		// checkInputElementClass(ChronoEdge.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine both(final BsonArray labels, final int branchFactor) {
		// Check Input element class
		checkInputElementClass(ChronoVertex.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine out(final BsonArray labels, final int branchFactor) {
		// Check Input element class
		checkInputElementClass(ChronoVertex.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine in(final BsonArray labels, final int branchFactor) {
		// Check Input element class
		checkInputElementClass(ChronoVertex.class);
	...
	public OrientTraversalEngine toEvent(final Long timestamp) {
		// Check Input element class
	...
	public OrientTraversalEngine toEvent(final LongInterval interval) {
		// Check Input element class
		checkInputElementClass(ChronoVertex.class, ChronoEdge.class);
	...
	public OrientTraversalEngine toElement() {
		// Check Input element class
	...
	public OrientTraversalEngine outEe(final BsonArray labels, final TemporalType typeOfEdgeEvent, final AC tt,
	...
	public OrientTraversalEngine inEe(final BsonArray labels, final TemporalType typeOfEdgeEvent, final AC tt,
			final AC s, final AC e, final AC ss, final AC se, final AC es, final AC ee) {
		// Check Input element class
		checkInputElementClass(VertexEvent.class);
	...
	public OrientTraversalEngine oute(final BsonArray labels, final TemporalType typeOfVertexEvent, final AC tt,
	...
	public OrientTraversalEngine bothe(final String label, final AC tt) {
		// Check Input element class
		checkInputElementClass(VertexEvent.class);
	...
	public OrientTraversalEngine oute(final String label, final AC tt) {
		// Check Input element class
		checkInputElementClass(VertexEvent.class);
	...
	public OrientTraversalEngine ine(final String label, final AC tt) {
		// Check Input element class
		checkInputElementClass(VertexEvent.class);
	...
	public OrientTraversalEngine ine(final BsonArray labels, final TemporalType typeOfVertexEvent, final AC tt,
			final AC s, final AC e, final AC ss, final AC se, final AC es, final AC ee, final Position pos) {
		// Check Input element class
		checkInputElementClass(VertexEvent.class);
	...
	public OrientTraversalEngine inVe() {
		// Check Input element class
	...
	public OrientTraversalEngine outVe() {
		// Check Input element class
		checkInputElementClass(EdgeEvent.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine shuffle() {
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine gather() {
		// Check Invalid Input element class
		checkInvalidInputElementClass(List.class);
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine scatter() {
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine transform(final PipeFunction function, final Class outputClass) {
		// Pipeline Update
	...
	public OrientTraversalEngine order(final Comparator comparator) {
		// Pipeline Update
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine dedup() {
		// Pipeline Update
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine except(final Collection collection) {
		// Pipeline Update
	...
	public OrientTraversalEngine retain(final Collection collection) {
		// Pipeline Update
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine filter(final PipeFunction filterFunction) {
		// Pipeline Update
	...
	public OrientTraversalEngine elementDedup(FC fc) {
		// Stream Update
		if (isPathEnabled) {
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine random(final Double bias) {
		// Pipeline Update
		if (isPathEnabled) {
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine range(final int maxSize) {
		// Pipeline Update
		if (isPathEnabled) {
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine simplePath() {
		// Pipeline Update
		if (isPathEnabled) {
	...
	public OrientTraversalEngine sideEffect(final PipeFunction sideEffectFunction) {
	...
	public OrientTraversalEngine ifThenElse(final PipeFunction ifFunction, final PipeFunction thenFunction,
	...
	private OrientTraversalEngine innerLoop(final List<Step> stepList, final LoopPipeFunction whileFunction) {
		...
		if (isPathEnabled) {
			...
			List intermediateList = (List) stream.flatMap(e -> {
				...
				if ((boolean) whileFunction.compute(intermediate, currentPath, this.loopCount)) {
					...
					OrientTraversalEngine innerPipeline = new OrientTraversalEngine(g, e, isParallel,
	 ...
	 * @return the extended Pipeline
	 */
	public OrientTraversalEngine loop(final String namedStep, final LoopPipeFunction whileFunction) {
		// Pipeline Update
	...
	public OrientTraversalEngine as(final String name) {
		// Step Update
		final Class[] args = new Class[1];
		args[0] = String.class;
	...
	private OrientTraversalEngine invoke(final List<Step> stepList) {
