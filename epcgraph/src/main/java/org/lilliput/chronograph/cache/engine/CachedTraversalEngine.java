package org.lilliput.chronograph.cache.engine;
...
public class CachedTraversalEngine {
	...
	public CachedTraversalEngine() {

	}

	public CachedTraversalEngine setStartsLazy(final Object starts, final boolean setParallel,
